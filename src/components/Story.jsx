        ...
        <section id="story" className=" min-h-dvh w-screen bg-black text-blue-50">
            <div className="flex size-full items-center flex-col py-10 pb-24">
                ...
                <div className=" relative size-full ">
                    <AnimatedTitle
                        title="the <b>story</b>of <br/>the hidden realm</>"
                        sectionId = "#story"
                ...
                <div className=" -mt-80 flex w-full justify-center md:-mt-64 md:me-44 md:justify-end">
                    <div className="flex h-full w-fit flex-col items-center md:items-start">
                        <p className=" mt-3 max-w-sm text-center font-circular-web text-violet-50 md:text-start">
                            ...
                            unravel its mysteries. Join us on a journey of discovery and adventure as we navigate the
                            hidden realm of zentry.
                        </p>
